...
# One optional local query embedding, bounded by the standard model's 512 tokens.
# Lexical/identity requests consume none; callers may still explicitly forbid it.
DEFAULT_BUDGET = Budget(300000, 16 * 1024 * 1024, 80000, 100, 50, 100, 2, 512,
                        model_calls=1, model_input_tokens=512)
