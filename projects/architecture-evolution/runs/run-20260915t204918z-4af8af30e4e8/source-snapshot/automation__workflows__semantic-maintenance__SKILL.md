...
逐项比较新旧依据对适用域、结论、反证和下游表述的影响。给出retain/revise/resynthesize/retract/defer与具体理由；修改正文遵守现行 memory-v4 聚合契约（旧类型及 L1/文稿仍用原版本），未知或超范围项保持defer。原件只读，不直接改规范JSON或删除旧版本。
