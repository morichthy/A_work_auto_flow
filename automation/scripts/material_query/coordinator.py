...
class Coordinator:
    ...
    def capabilities(self):
        ...
        return {"enabled": True, "api_version": "0.2", "definitions_version": definitions.VERSION,
                ...
                "full_documents": True,
                "reading_workflow": {"version": "5", "actions": ["template", "start", "recall", "page", "read", "note", "decide", "resume", "list", "view", "bind", "archive", "delegate", "handoff"],
                                     "modes": ["legacy", "owner_document"], "template_mode": "owner_document",
                                     "owner_context": preferences['settings']['reading'].get('context', {'max_owners': 10, 'note_max_tokens': 6000}),
                                     "persistent": True, "automatic_semantic_judgment": False,
                                     "delegation": {"execution": "host-agent-tools", "automatic_dispatch": False,
                                                    "handoff": "notes-only", "default_max_chars": 12000,
                                                    "fallback": "single-agent", "external_model_tokens_metered": False},
                                     "reranking": {"version": "context-conditions-ce-v1", "modes": ["off", "auto", "required"],
                                                   "provider": "onnx-cross-encoder", "conditions": "explicit-field-only",
                ...
                "limits": asdict(SERVER_LIMITS), "default_budget": preferences['settings']['materials']['budget'],
                "default_result_limit": preferences['settings']['materials']['result_limit'],
                "workspace_policy": preferences['settings']['collaboration'], "settings_revision": preferences['revision'],
                "query_ttl_seconds": self.store.ttl,
